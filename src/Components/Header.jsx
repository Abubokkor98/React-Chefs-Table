...
<div className='flex flex-col md:flex-row md:justify-between items-center my-8 space-y-4'>
  ...
  <div className='flex flex-row justify-between items-center gap-4'>
    ...
    <div className='flex justify-between items-center relative'>
      <i className="fa-solid fa-magnifying-glass absolute left-3 text-gray-600 text-xl"></i>
      
      <input
        className='py-4 pl-10 pr-4 bg-gray-100 rounded-full placeholder-gray-800 outline-none'
        type="text" 
        placeholder='Search'/>
    </div>
    {/* search end */}
