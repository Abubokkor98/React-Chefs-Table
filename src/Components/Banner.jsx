...
export default function Banner() {
  return (
    <div className='bg-cover bg-no-repeat rounded-3xl md:w-full h-full md:h-[35.5rem] mb-10' style={{backgroundImage: 'url(https://i.ibb.co.com/By7Z5HT/portrait-indigenous-person-integrated-into-modern-life.jpg)'}}
    >
